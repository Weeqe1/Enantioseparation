...
MODEL_NAME = 'GAT model'        # MODEL_NAME: 'GAT model', 'Linear_Regression', 'Support_Vector_Regression',
                                        # 'Gradient_Boosting_Regressor', 'Neural_Network_Regressor', 'RandomForest'
